		...
		<div class="row border border-3">
			<div class="col-md-6">
				<div class="container-fluid text-end my-3">
					<img src="product-images\<%= product.getProductImages() %>"
						class="card-img-top"
			...
			<div class="col-md-6">
				<div class="container-fluid my-5">
					...
					<span class="real-price">LKR <%=product.getProductPriceAfterDiscount()%></span>&ensp;
					<span class="product-price">LKR <%=product.getProductPrice()%></span>&ensp;
