...
<body>
	...
	<div class="container text-center py-5 px-5">
		<img src="Add-Images/empty-cart.png" style="max-width: 250px;"
			class="img-fluid">
		<h4 class="mt-5">Your cart is empty!</h4>
		<p>Add items to it now.</p>
		<a href="index.jsp" class="btn btn-primary btn-lg" role="button"
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr class="text-center">
						...
						<td>LKR <%=prod.getProductPriceAfterDiscount()%></td>
						<td><a
						...
						<td>LKR <%=c.getQuantity() * prod.getProductPriceAfterDiscount()%></td>
						<td><a
